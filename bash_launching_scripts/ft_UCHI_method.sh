...
OUTDIR="./training_run_test_UCHIDA" # Output directory for training results
...
METRICS="uchida_extraction,fid50k_full" #,fid50k_full" # Metric for the evaluation of T4G method

# Path configuration
PATH_CONF="/home/mzoughebi/personal_study/StyleGAN2-ADA-4_Watermarking_VF/configs/watermarking_dict_conf_UCHI.json"
