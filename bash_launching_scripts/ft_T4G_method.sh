...
# =================================================================
# Training script for fine-tuning StyleGAN2-ADA with T4G method
# =================================================================

# --- Default parameters  ---
SNAP=1 
OUTDIR="./T4G_128_128_AFHQ" 
...
METRICS="T4G_extraction,fid50k_full" # Metric to evaluate of IPR method
PATH_CONF="./configs/watermarking_dict_conf_T4G.json"  # Path configuration
